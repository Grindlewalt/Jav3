...
ephemeral = contextvars.ContextVar("jav3_ephemeral", default=False)
...
artifact_slug = contextvars.ContextVar("jav3_artifact_slug", default=None)
...
event_chan = contextvars.ContextVar("jav3_event_chan", default=None)
...
web_session = contextvars.ContextVar("jav3_web_session", default=None)
...
ACTIVE_UNSET = object()
active_project = contextvars.ContextVar("jav3_active_project",
...
# machine. Without it "play something" started the track in every open Jav3
...
gui_tab = contextvars.ContextVar("jav3_gui_tab", default=None)
...
conversation_id = contextvars.ContextVar("jav3_conversation_id", default=None)
...
spawn_depth = contextvars.ContextVar("jav3_spawn_depth", default=0)
